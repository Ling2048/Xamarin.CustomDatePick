...
{
    public class ScrollMonthDateView : View, System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static readonly BindableProperty ThingProperty = BindableProperty.Create(
            propertyName: "Thing",
            returnType: typeof(List<DateTime>),
            declaringType: typeof(MonthDateView),
            defaultValue: null);

        public List<DateTime> Thing
        {
            get { return (List<DateTime>)GetValue(ThingProperty); }
